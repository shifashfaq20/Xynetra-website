...
// Server actions — only async functions allowed from a "use server" file.
import {
  getDashboardStats,
  getUpcomingAppointments,
  getRecentReminders,
...
// Shared types/constants — plain TS module (no "use server").
import type { WaitlistPayload } from "@/lib/dashboard/waitlist-types";
...
async function loadDashboard(supabase: any, userId: string) {
  ...
  return {
    ...
    appointments,
    reminders,
    waitlistPayload: waitlistPayload as WaitlistPayload,
    handoffs,
    client: (clientRes?.data ?? null) as ClientRow,
  };
}
